...
gsap.from(".ice h1", { opacity: 0, duration: 1, delay: 1.5, y: -100 });
gsap.from(".ice p", { opacity: 0, duration: 1, delay: 2, x: -100 });
gsap.from(".ice .btn", { opacity: 0, duration: 1, delay: 2.5, x: -20 });
gsap.from(".nav-item", {
  opacity: 0,
  duration: 1,
  delay: 1.2,
