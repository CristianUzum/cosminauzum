...
const navLinksItems = document.querySelectorAll('.nav-links li a'); // Selectăm toate link-urile din navbar
hamburger.addEventListener('click', ()=>{
    navLinks.classList.toggle('active');
    hamburger.classList.toggle('active');
});
// Adăugăm un event listener pentru fiecare link din navbar
navLinksItems.forEach((link)=>{
    link.addEventListener('click', ()=>{
        navLinks.classList.remove('active'); // Ascundem navbar-ul
        hamburger.classList.remove('active'); // Închidem hamburger-ul
    });
});
